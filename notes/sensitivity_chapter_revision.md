...
Specific locations:
1. **Intro** (line 8): "A two-currency analysis would miss all of these effects." [item 3]
2. **QoI 3 definition** (line 100): "This quantity is structurally zero in a two-currency model where GBP does not exist." [item 9]
3. **End of QoI definitions** (line 126): "QoIs 1, 2, and 4 have direct analogues in a two-currency setting. QoIs 3 and 5 probe mechanisms that exist only with three or more currencies." [item 12]
4. **QoI 3 results** (line 237): "This QoI probes a mechanism that does not exist in a two-currency model" [item 20]
5. **Discussion 4.5.1** (line 352): "The sensitivity rankings for QoIs 1, 2, and 4 reproduce what a two-currency analysis (with 8 parameters) would give." [item 36]
...
### G9. More discussion like end of 4.5.3 [item 46]
